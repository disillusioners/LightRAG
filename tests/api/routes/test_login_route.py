...
def _build_server(monkeypatch):
    ...
    # rather than ``lightrag.api.lightrag_server.LightRAG`` (which is no
    # longer re-exported at the server module level).
    monkeypatch.setattr("lightrag.api.workspace_manager.LightRAG", _FakeLightRAG)
